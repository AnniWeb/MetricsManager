...
namespace MetricsAgentsManager.Cron.Job
{
    ...
    public class DotNetMetricJob : IJob
    {
        ...
        private readonly string _apiMethod = "metrics/dotnet";
        ...
        private async Task<IList<DotNetMetricResponse>> GetMetricsByPeriod(AgentInfo agent, DateTimeOffset fromTime,
            DateTimeOffset toTime)
        {
            ...
            return await _metricsClient.GetMetricsByPeriod<ListDotNetMetricsResponse, DotNetMetricResponse>(request)
