...
namespace MetricsAgentsManager.Cron.Job
{
    ...
    {private readonly IRamMetricsRepository _metricsRepository;
        ...
        private readonly string _apiMethod = "metrics/ram";

        public RamMetricJob(IRamMetricsRepository metricsRepository, IAgentsRepository agentsRepository, IMetricsClient metricsClient)
        {
        ...
        private async Task<IList<RamMetricResponse>> GetMetricsByPeriod(AgentInfo agent, DateTimeOffset fromTime,
            DateTimeOffset toTime)
        {
            ...
            return await _metricsClient.GetMetricsByPeriod<ListRamMetricsResponse, RamMetricResponse>(request)
