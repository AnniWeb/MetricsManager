...
namespace MetricsAgentsManager.Cron.Job
{
    ...
    {private readonly INetworkMetricsRepository _metricsRepository;
        ...
        private readonly string _apiMethod = "metrics/network";
        ...
        private async Task<IList<NetworkMetricResponse>> GetMetricsByPeriod(AgentInfo agent, DateTimeOffset fromTime,
            DateTimeOffset toTime)
        {
            ...
            return await _metricsClient.GetMetricsByPeriod<ListNetworkMetricsResponse, NetworkMetricResponse>(request)
